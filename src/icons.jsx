...
const Indicator =  () => {
return <svg className={"backing-product__indicator"} xmlns="http://www.w3.org/2000/svg" width="78" height="78" viewBox="0 0 78 78">
    <g id="indicator" transform="translate(-5880 2017)">
        ...
        <circle id="inner" cx="20" cy="20" r="20" transform="translate(5899 -1998)" fill="#05bb42"/>
    </g>
</svg>

}
export {Logo, LogoMasterCraft, LogoBookmark, Check, Indicator}